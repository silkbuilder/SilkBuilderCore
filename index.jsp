...
<%
	...
	/*
	 * SilkBuilder starting only.
	 */
	session.setAttribute("devSession", true);
	
	String menuLink = "WEB-INF/silk/SilkBuilderIDE/selector/index.jsp";
	String loginLink = "WEB-INF/silk/SilkBuilderIDE/selector/login.srv";
