...
INSERT INTO silkNode (nodeType, name, fileName, extension, nodeLevel, parent, editor, saveMode, import, parentFilter, iconName, iconColor, template, recordOrder, sync)
VALUES
	('CSF','Private Service',NULL,'.jsp',3,0,1,2,1,'SRV','fa-solid fa-satellite-dish','#81dafc','<%@page contentType="text/html;charset=UTF-8" import="com.oopsclick.silk.dbo.*,java.io.*" trimDirectiveWhitespaces="true" %>' || chr(13) || chr(10) || '<%' || chr(13) || chr(10) || '	' || chr(13) || chr(10) || '%>',10,1);

INSERT INTO silkNode (nodeType, name, fileName, extension, nodeLevel, parent, editor, saveMode, import, parentFilter, iconName, iconColor, template, recordOrder, sync)
VALUES
	('CSFP','Public Service',NULL,'.srv',3,0,1,2,1,'SRV','fa-solid fa-satellite-dish','#a0e7a0','<%@page contentType="text/html;charset=UTF-8" import="com.oopsclick.silk.dbo.*,java.io.*" trimDirectiveWhitespaces="true" %>' || chr(13) || chr(10) || '<%' || chr(13) || chr(10) || '' || chr(13) || chr(10) || '%>',13,1);
